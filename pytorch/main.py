...
parser.add_argument('--dataset_path', default='/workspace/data/cifar10', type=str)
...
parser.add_argument('--pi_2', type=float, default=0.2, help='The class prior probability.')
...
def main():
    ...
    testset, num_classes = datasets.registry.get(args.dataset, args.dataset_path, train=False, seed=args.dataset_seed)
